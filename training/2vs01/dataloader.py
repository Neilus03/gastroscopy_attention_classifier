...
if __name__ == "__main__":
    ...
    train_dataset = EGDDataset(root_dir="/home/ndelafuente/CVC/EGD_Barcelona/gastroscopy_attention_classifier/training/2vs01/2-01/", transform=transform, train=True)
    
    # Create dataset for testing
    test_dataset = EGDDataset(root_dir="/home/ndelafuente/CVC/EGD_Barcelona/gastroscopy_attention_classifier/training/2vs01/2-01/", transform=transform, train=False)
