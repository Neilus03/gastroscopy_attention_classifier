...
# Initialize wandb
wandb.init(project='gastroscopy_classifier_training_2vs01', entity='neildlf')
...
root_dir = "/home/ndelafuente/CVC/EGD_Barcelona/gastroscopy_attention_classifier/training/2vs01/2-01"
   ...
   # Initialize the model and optimizer
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f"/home/ndelafuente/CVC/EGD_Barcelona/gastroscopy_attention_classifier/kfold_weights_k4_2vs01/model_fold_{fold}.pth")
